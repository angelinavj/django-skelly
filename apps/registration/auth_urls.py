...
urlpatterns = patterns('',
 ...
 url(r'^password/change/$', auth_views.password_change, {'password_change_form': PasswordChangeForm}, name='auth_password_change'),
 ...
 url(r'^password/reset/confirm/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
   auth_views.password_reset_confirm, {'set_password_form': SetPasswordForm},
